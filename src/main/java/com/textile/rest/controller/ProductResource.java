...
import com.textile.repository.ProductCommentRepository;
...
public class ProductResource {
     ...
     * */
    @RequestMapping("/s")
    public ResponseEntity<Model> getProductsByKeyword(@RequestParam(value = "na", required = false) String productName,
     ...
     * */
    @RequestMapping("/p")
    public ResponseEntity<Model> viewProduct(@RequestParam(value = "id", required = true) Long productId, Model model,
    ...
    public ResponseEntity<String> addProductComment(@RequestParam(value = "id", required = true) Long productId,
